...
- **DO:** Use native LSP tools ('lsp_definition', 'lsp_references', 'lsp_symbols', 'lsp_implementation') for precise semantic navigation whenever possible. These are much more accurate than grep.
