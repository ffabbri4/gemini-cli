...
export const LSP_GLOBAL_SYMBOLS_TOOL_NAME = 'lsp_global_symbols';
export const LSP_TYPE_DEFINITION_TOOL_NAME = 'lsp_type_definition';
export const LSP_HOVER_TOOL_NAME = 'lsp_hover';
export const LSP_RENAME_TOOL_NAME = 'lsp_rename';
export const LSP_FIX_TOOL_NAME = 'lsp_fix';
export const LSP_CAPABILITIES_TOOL_NAME = 'lsp_capabilities';
export const LSP_PARAM_LINE = 'line';
export const LSP_PARAM_CHARACTER = 'character';
export const LSP_PARAM_NEW_NAME = 'new_name';
